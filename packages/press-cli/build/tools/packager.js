...
function add(pkg, options) {
    if (options === void 0) { options = packageOptions; }
    if (options.expo) {
...
exports.packager = {
    run: function (command, options) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (yarn()) {
                    return [2 /*return*/, spawn_1.spawnProgress("yarn " + command, { onProgress: options.onProgress })];
                }
                else {
                    return [2 /*return*/, spawn_1.spawnProgress("npm run " + command, { onProgress: options.onProgress })];
                }
                return [2 /*return*/];
            });
        });
    ...
    add: function (pkg, options) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                cmd = add(pkg, options);
                return [2 /*return*/, spawn_1.spawnProgress(cmd, { onProgress: options.onProgress })];
            });
        });
    },
